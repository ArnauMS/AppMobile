...
class PageProject extends StatefulWidget {
  @override
  int idDaddy;

  PageProject(this.idDaddy);

  _PageProjectState createState() => _PageProjectState();
}

class _PageProjectState extends State<PageProject> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        Row(mainAxisSize: MainAxisSize.min, children: [
          ElevatedButton(
            onPressed: () {
              createChild(idDaddy, name.text, (tags.text).replaceAll(RegExp(r" "), ""), "project");
